                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @if(isset($nomor))
                                                <span>Waktunya upload PDF yang telah diberi nomor dan disahkan</span>
                                                <div>
                                                    <br>
                                                    <form class="form-material" method="post" action="/penerbitanbeterf-{{$inputs->id}}" enctype="multipart/form-data">
                                                        @csrf
                                                    ...
                                                    <label for="cebox" style="font-family:Helvetica; color:grey">
                                                            Saya nyatakan bahwa PDF ini sudah diberi nomor dan disahkan
                                                            @if($inputs->jenisop != 'Usulan SOP Eksis')
                                                            secara elektronik
                                                            @endif
                                                    </label>
                                                    <br>
                                                    <input type="submit" id="tombol" name="upload" class="btn btn-success text-dark" style="display:none" value="Upload PDF Final dan terbitkan" >
                                                    </form>
                                            @else
                                                <span>
                                                    ...
                                                    <div>
                                                        <form class="form-material" method="post" action="/penerbitanbeter-{{$inputs->id}}">
                                                            @csrf
                                                            <div class="form-group">
