...
@section('title', 'Input Usulan SOP Baru')
@section('isi')
<x-breadcrumb judul="Input Usulan SOP Baru" item="Input" href="" />
          ...
          <div class="container-fluid">
              <div class="row">
                  <div class="col-lg-8 col-xlg-9 col-md-7">
                      <div class="card">
                          <div class="card-body">
                              <form class="form-horizontal form-material mx-2" method="post" action="/sopparu" enctype="multipart/form-data">
                                @csrf
